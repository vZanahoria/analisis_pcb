Sub CopiarYTransponerColumnasParaTodosLosArchivosAltura()
    ...
    Do While Archivo <> ""
        ...
        ' Especifica el rango de columnas que deseas copiar en el libro de origen (F, G, I desde la fila 10)
        Set RangoOrigen = Union(HojaOrigen.Range("F10:F" & HojaOrigen.Cells(HojaOrigen.Rows.Count, "F").End(xlUp).Row), _
                                ...
                                HojaOrigen.Range("I10:I" & HojaOrigen.Cells(HojaOrigen.Rows.Count, "I").End(xlUp).Row))
